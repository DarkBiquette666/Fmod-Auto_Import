...
class FMODProject:
    ...
    def __init__(self, project_path: str):
        ...
        # CACHE PROBABLEMENT OBSOLÈTE - À supprimer si pas de problème de performance
        # Code gardé temporairement au cas où on remarque des lenteurs
        ...
        # CACHE DÉSACTIVÉ - Charge toujours depuis XML (pas de différence de perf constatée)
    ...
    def get_events_in_folder(self, folder_id: str) -> List[Dict]:
        ...
        # Parse XML files directement (pas de différence de perf avec cache)
