# 📁 Package Contents - Moco Auto Import
...
| File | Description |
|------|-------------|
| `moco_auto_import.py` | Main Python script (189 KB) |
...
2. Launch directly: `python moco_auto_import.py`
...
3. **Advanced features:** [../README.md](../README.md) - "Common Use Cases" section
...
zip -r MocoAutoImport-v1.0.0.zip MocoAutoImport-Package/
```

**Option 2: Git Repository**
```bash
# Initialize a git repo (optional)
cd MocoAutoImport-Package
git init
git add .
...
Simply copy the complete `MocoAutoImport-Package` folder
